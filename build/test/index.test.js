"use strict";
// import {Pool} from 'pg';
// import SqlClient, {TLogger, TSqlClientOptions} from '../src/index';
...
//   const defaultOptions: TSqlClientOptions = {
//     user: 'testuser',
//     host: 'localhost',
//     database: 'testdb',
//     password: 'testpass',
...
//     sqlClient = new SqlClient(defaultOptions, mockLogger);
//   });
//   describe('Constructor', () => {
//     it('should create instance with custom logger', () => {
//       const client = new SqlClient(defaultOptions, mockLogger);
//       expect(Pool).toHaveBeenCalledWith({...defaultOptions, ssl: true});
//     });
//     it('should create instance with default console logger', async () => {
//       const consoleSpy = jest.spyOn(console, 'info');
//       const client = new SqlClient(defaultOptions);
//       expect(Pool).toHaveBeenCalledWith({...defaultOptions, ssl: true});
...
//       await expect(sqlClient.executeDDL(invalidQuery)).rejects.toThrow(
//         'Invalid SQL command',
//       );
//     });
//     it('should throw error for invalid DQL command', async () => {
//       const invalidQuery = 'INSERT INTO users (name) VALUES ($1)';
//       await expect(sqlClient.executeDQL(invalidQuery)).rejects.toThrow(
//         'Invalid SQL command',
//       );
//     });
//     it('should throw error for invalid DML command', async () => {
//       const invalidQuery = 'SELECT * FROM users';
//       await expect(sqlClient.executeDML(invalidQuery)).rejects.toThrow(
//         'Invalid SQL command',
//       );
//     });
//   });
...
//       await expect(sqlClient.executeDDL(query)).rejects.toThrow(
//         'Database error',
//       );
//       expect(mockLogger.error).toHaveBeenCalledWith(
//         'Error executing DDL query:',
//         error,
//       );
//       expect(mockRelease).toHaveBeenCalled();
//     });
...
//       const error = new Error('Database error');
//       mockQuery.mockRejectedValueOnce(error);
//       await expect(sqlClient.executeDQL(query)).rejects.toThrow(
//         'Database error',
//       );
//       expect(mockLogger.error).toHaveBeenCalledWith(
//         'Error executing DQL query:',
//         error,
//       );
//       expect(mockRelease).toHaveBeenCalled();
//     });
...
//       const error = new Error('Database error');
//       mockQuery.mockRejectedValueOnce(error);
//       await expect(sqlClient.executeDML(query)).rejects.toThrow(
//         'Database error',
//       );
//       expect(mockLogger.error).toHaveBeenCalledWith(
